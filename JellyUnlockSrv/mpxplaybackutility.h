...
public:
    ...
    *  @return playback utility object
    */
    IMPORT_C static MMPXPlaybackUtility* NewL(const TMPXCategory aCategory,const TUid& aModeId = KPbModeDefault,MMPXPlaybackObserver* aObs=NULL);
    ...
    * @since S60 3.2.3
    */
    IMPORT_C static MMPXPlaybackUtility* UtilityL(const TUid& aModeId = KPbModeDefault );
